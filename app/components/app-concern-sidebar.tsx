    ...
    mails: [
        {
            ...
            date: "2025-10-14",
            teaser: "Slow internet connection in the main office. Department: IT Department.",
            priority: "Normal",
        },
        {
            name: "Anna Reyes",
            email: "anna.reyes@example.com",
            subject: "Account Issue (2)",
            date: "2025-10-15",
            teaser: "Cannot log into email account after password reset. Department: Customer Support.",
            priority: "Critical",
        },
        {
            name: "Mark Dela Cruz",
            email: "mark.dc@example.com",
            subject: "Software Installation Request (3)",
            date: "2025-10-16",
            teaser: "Requesting installation of Adobe Creative Suite on workstation 12. Department: Marketing.",
            priority: "High",
        },
    ] as MailItem[],
    ...
    const openAddDialog = () => {
        ...
        if (selectedMail) {
            ...
            setTicketForm({
                ...
                type: type, // This is the Type of Concern
                remarks: selectedMail.teaser,
                priority: selectedMail.priority, // Use the priority from the mail
            })
        }
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                <DialogContent className="sm:max-w-3xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Review and finalize the ticket details based on the email concern. Required fields are marked with a **red border** if left empty.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3 mt-4 text-sm">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            {/* Row 2 */}
                            {/* Request Type (Required + Red Border) */}
                            <div className="flex flex-col space-y-1.5">
