...
export function LoginForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
<div className={cn("flex flex-col gap-6 border-2 border-blue-600 rounded-lg p-6 shadow-md bg-white", className)} {...props}>
  <form onSubmit={handleSubmit}>
    <FieldGroup>
      ...
      <FieldDescription className="text-center mt-2 text-gray-600">
        For end users only. Don't have an account? <a href="/dsi-signup" className="underline text-blue-600">Sign up</a>
      </FieldDescription>
    </FieldGroup>
  </form>
</div>
